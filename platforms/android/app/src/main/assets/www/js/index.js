...
// Show and close all game screens
...
// Single- and Multiplayer Logic
document.getElementById("singleplayer").addEventListener("click", function(){
  // Start Singleplayer Socket
  var socket_single = io.connect('http://localhost:8731');
  // Things to do whenever connected
  socket_single.on('connect', function(){
  ...
  socket_single.on('disconnect', function(){
    alert('Oh oh, please restart MemoryPoker');
